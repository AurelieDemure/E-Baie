...
public class MarketModelTest {
    ...
    public void testOffers() {
        ...
        assert MarketModel.getOffersAvailableFiltered("----", "", OfferType.LOAN, null, null, null, null).size() == 1;
        assert MarketModel.getOffersAvailableFiltered("----", "", null, null, Price.LESS100, null, null).size() == 1;
        assert MarketModel.getOffersAvailableFiltered("----", "", null, null, Price.FROM400TO500, null, null).size() == 1;
    }
