...
public class MarketModelTest {
    ...
    public void testOffers() {
        ...
        assert MarketModel.getOffersAvailableFiltered("----", null, OfferType.LOAN, null, null, null).size() == 1;
        assert MarketModel.getOffersAvailableFiltered("----", null, null, null, Price.LESS100, null).size() == 1;
        assert MarketModel.getOffersAvailableFiltered("----", null, null, null, Price.FROM400TO500, null).size() == 1;
    }
